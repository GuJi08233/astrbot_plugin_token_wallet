...
### 核心特性
- **动态代币符号**: 自动从合约读取代币符号，所有显示自动适配
- **并发安全**: 使用asyncio.Lock防止同一用户并发交易导致Nonce冲突
- **服务层封装**: 所有链上交互通过eth.py服务层，保持代码清晰
- **异常处理**: 完善的异常分类和错误提示
...
- [以太坊ERC20标准](https://eips.ethereum.org/EIPS/eip-20)
